...
BEGIN
	DELETE FROM class where class_name = p_class_name AND user_id = p_user_id AND user_id = p_class_id;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
	DELETE FROM race where race_name = p_race_name AND user_id = p_user_id AND user_id = p_race_id;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
